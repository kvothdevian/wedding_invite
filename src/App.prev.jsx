...
function PageFrame({ children }) {
  return (
    <div className="relative">
      {/* outer ornate frame — continuous, not card */}
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-paper text-ink antialiased overflow-x-hidden">
      ...
      <PageFrame>
        {/* Top thin ornate strip — continuous */}
        ...
        {/* HERO — full-bleed editorial, not a card */}
        <section className="relative bg-paper">
          <div className="absolute inset-0 opacity-[0.04]" style={{ backgroundImage: `radial-gradient(circle at 1px 1px, var(--color-slate) 1px, transparent 0)`, backgroundSize: '26px 26px' }} aria-hidden="true" />
          <div className="relative mx-auto max-w-[1200px] px-4 md:px-6">
            {/* Ganesh — auspicious opening, appropriately placed at top center */}
            ...
            <div className="text-center mt-6 md:mt-8 pb-8">
              ...
              {/* countdown — inline hairline pills, not cards */}
              <div className="mt-8 flex flex-wrap justify-center divide-x divide-border border-y border-border bg-snow/60">
                {[
          ...
          {/* continuous mountain ridge divider — full-bleed */}
        ...
        {/* SCHEDULE — continuous timeline, not cards */}
        <section id="schedule" className="bg-snow border-b border-border">
          <div className="mx-auto max-w-[1200px] px-4 md:px-6 py-10 md:py-14">
            <div className="flex items-end justify-between gap-4 flex-wrap">
              ...
              <p className="hidden md:block font-mono text-[11px] tracking-[0.12em] text-muted">— scroll gently, same venue —</p>
            </div>

            <div className="mt-8 border-y border-border bg-paper divide-y divide-border">
              {events.map((e) => (
                <div key={e.id} className="grid grid-cols-[64px_1fr] md:grid-cols-[84px_1fr_160px] gap-0 items-stretch group hover:bg-snow/40 transition-colors">
                  <div className="flex items-center justify-center border-r border-border bg-snow/30">
                    <e.Icon size={32} />
                  </div>
        ...
        {/* VENUE — full-bleed split, no card */}
      ...
      <footer className="bg-slate text-snow">
        <div className="mx-auto max-w-[1200px] px-4 md:px-6 py-10">
          ...
          <div className="mt-8 pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-3 font-mono text-[11px] tracking-[0.12em] text-snow/50">
            ...
            <span className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-haldi" /> Vite + React + Tailwind v4</span>
          </div>
        </div>
      </footer>
    </div>
